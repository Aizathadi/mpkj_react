            ...
            <form action="{{ route('assets.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="site_name" 
                           class="w-full bg-gray-800/80 text-gray-100 border border-gray-700 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-inner" 
                           required>
                </div>
                ...
                <div class="flex justify-between pt-4">
                    <a href="{{ route('assets.index') }}" 
                       class="px-6 py-2 bg-gray-700 hover:bg-gray-600 text-gray-200 rounded-lg shadow-md font-semibold transition transform hover:scale-105">
                        ← Back
                    </a>
                    <button type="submit" 
                            class="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg shadow-md font-semibold transition transform hover:scale-105">
                        💾 Save
                    </button>
                </div>
            </form>
